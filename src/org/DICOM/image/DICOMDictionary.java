...
public class DICOMDictionary {
  ...
  public Hashtable getDictionary() {
    ...
    try {
      StreamTokenizer st = new StreamTokenizer(new BufferedReader(new InputStreamReader(this.getClass().getClassLoader().getResourceAsStream("DICOM-dict.txt"))));
      String line;
      ...
      while(true) {
        ...
        //System.out.println("0x" + tag + " vr: " +vr + " name: " + name);
