...
public class DICOMMetadataFormat extends IIOMetadataFormatImpl {
  ...
  private DICOMMetadataFormat() {
    super("edu.ucla.rip.JWS.DICOMMetadata_1.0", CHILD_POLICY_REPEAT);

    addElement("KeywordValuePair", "org.DICOM.image.DICOMMetadata_1.0", CHILD_POLICY_EMPTY);

    //addAttribute("KeywordValuePair", "keyword", DATATYPE_INTEGER, true, null);
