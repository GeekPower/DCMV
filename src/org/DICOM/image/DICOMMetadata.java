...
public class DICOMMetadata extends IIOMetadata {
  ...
  public Node getAsTree(String formatName) {
    if(!formatName.equals(nativeMetadataFormatName)) throw new IllegalArgumentException("Bad format name!");
  ...
  public void mergeTree(String formatName, Node root) throws IIOInvalidTreeException {
    ...
    Node node = root;
    if(!node.getNodeName().equals(nativeMetadataFormatName)) fatal(node, "Root must be " + nativeMetadataFormatName);
  }
